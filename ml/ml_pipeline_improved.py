...
class ImprovedCryptoLSTMPipeline:
    ...
    def __init__(self, symbol='BTCUSDT', interval='1h', lookback_period=24, 
        ...
        Args:
            ...
            use_binary_classification: Use binary (Up/Down) instead of 3-class classification
        """
        self.symbol = symbol
        self.interval = interval
        self.lookback_period = lookback_period
        self.prediction_horizon = prediction_horizon
        self.confidence_threshold = confidence_threshold  # Lowered to 35%
        ...
        # More aggressive trading thresholds (increased to ±0.5%)
        self.buy_threshold = buy_threshold     # Increased from 0.002 to 0.005 (0.5%)
        self.sell_threshold = sell_threshold   # Increased from -0.002 to -0.005
...
def main():
    ...
    results_3class = pipeline_3class.run_complete_analysis(csv_path)
    ...
    results_binary = pipeline_binary.run_complete_analysis(csv_path)
